package darkchoco.logging4basiccrudapi.service;
...
public class LoggingServiceImpl implements LoggingService{
    ...
    public void displayResp(HttpServletRequest request, HttpServletResponse response, Object body) {
        ...
        if(!headers.isEmpty()) {
            resMessage.append(" ResponseHeaders = [").append(headers).append("]");
        }

        resMessage.append(" responseBody = [").append(body).append("]");

        logger.info("log Response: {}", resMessage);
    }
