...
public class FluxMergingTests {
    ...
    public void mergeFluxes() {
        // delays needed to avoid the first flux from streaming the data through
        // before subscribing to the second flux.
        Flux<String> characterFlux = Flux
                .just("Garfield", "Kojak", "Barbossa")
                .delayElements(Duration.ofMillis(500));
        Flux<String> foodFlux = Flux
                .just("Lasagna", "Lollipops", "Apples")
                .delaySubscription(Duration.ofMillis(250))  // 0.25초 이후 구독 시작
                .delayElements(Duration.ofMillis(500));
    ...
    public void firstFlux() {
        ...
        Flux<String> firstFlux = Flux.first(slowFlux, fastFlux);  // 먼저 값을 방출하는 Flux를 선택한다
